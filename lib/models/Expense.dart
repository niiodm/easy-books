...
class Expense extends Model {
  ...
  const Expense._internal({required this.id, required description, required amount, required time, createdAt, updatedAt}): _description = description, _amount = amount, _time = time, _createdAt = createdAt, _updatedAt = updatedAt;
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'description': _description, 'amount': _amount, 'time': _time?.format(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
