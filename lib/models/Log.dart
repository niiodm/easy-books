...
class Log extends Model {
  ...
  const Log._internal({required this.id, required time, required log, required user, createdAt, updatedAt}): _time = time, _log = log, _user = user, _createdAt = createdAt, _updatedAt = updatedAt;
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'time': _time?.format(), 'log': _log, 'user': _user, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
