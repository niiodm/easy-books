...
class User extends Model {
  ...
  const User._internal({required this.id, required username, required password, required isAdmin, createdAt, updatedAt}): _username = username, _password = password, _isAdmin = isAdmin, _createdAt = createdAt, _updatedAt = updatedAt;
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'username': _username, 'password': _password, 'isAdmin': _isAdmin, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
