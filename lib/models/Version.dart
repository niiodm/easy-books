...
class Version extends Model {
  ...
  const Version._internal({required this.id, required version, required link, createdAt, updatedAt}): _version = version, _link = link, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Version({String? id, required int version, required String link}) {
  ...
  Version copyWith({String? id, int? version, String? link}) {
    return Version._internal(
      id: id ?? this.id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'version': _version, 'link': _link, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
